...
//    /// </summary>
//    public class RodMesh : MonoBehaviour
//    {
//        public Softbody m_body;
...
//        {
//            if(m_body == null)
//                m_body = GetComponent<Softbody>();

//            m_mesh = new Mesh();
//            m_mesh.name = "RopeMesh";

//            if (m_pointsCount == -1)
//                m_pointsCount = Mathf.Min(m_body.pointsCount - m_startId, m_body.pointsCount);

//            m_radii = new float[m_pointsCount];
//            m_uvs = new Vector2[m_resolution * m_pointsCount * m_smoothing];
//            for (int i = 0; i < m_pointsCount; i++)
//            {
//                m_radii[i] = m_radius * m_radiusScale.Evaluate((float)i / m_pointsCount);
//            }
...
//            DrawRope(transform, m_body.positions, m_startId, m_pointsCount, ref m_vertices, ref m_normals, ref m_uvs, m_radius, m_resolution, m_smoothing);
...
//            DrawRope(transform, m_body.positions, startId, numPoints, ref m_vertices, ref m_normals, ref m_uvs, m_radius, m_resolution, m_smoothing);

//            UpdateRopeTriangles(startId, numPoints, ref m_triangles, m_radius, m_resolution, m_smoothing);
...
//        public void DrawRope(Transform tr, Vector4[] points, int startId, int numPoints, ref Vector3[] verticesOut, ref Vector3[] normalsOut, ref Vector2[] uvsOut, float radius, int resolution, int smoothing)
//        {
