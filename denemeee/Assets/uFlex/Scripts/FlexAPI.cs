...
namespace uFlex
{
    ...
    public class Flex
    {
        ...
        #endif
        public static extern void UpdateSolver(IntPtr s, float dt, int substeps, IntPtr timers);
        ...
        /// Return Type: FlexSDF*
        #if (UNITY_32 || UNITY_EDITOR_32)
            [DllImportAttribute("flexRelease_x86", EntryPoint = "flexCreateSDF")]
        #else
        ...
        /// Return Type: void
        #if (UNITY_32 || UNITY_EDITOR_32)
        [DllImportAttribute("flexRelease_x86", EntryPoint = "flexDestroySDF")]
        #else
        ...
        ///source: FlexMemory
        #if (UNITY_32 || UNITY_EDITOR_32)
        [DllImportAttribute("flexRelease_x86", EntryPoint = "flexUpdateSDF")]
        #else
                [DllImportAttribute("flexRelease_x64", EntryPoint = "flexUpdateSDF")]
        #endif
        public static extern void UpdateSDF(IntPtr sdf, int dimx, int dimy, int dimz, IntPtr field, Memory source);
        ...
        ///numShapes: int
        //#if (UNITY_32 || UNITY_EDITOR_32)
        //[DllImportAttribute("flexRelease_x86", EntryPoint = "flexSetFields")]
        //#else
